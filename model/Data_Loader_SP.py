...
class OxfordPetsDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.transform:
            ...
            transformed_image = transforms.ToTensor()(image)  # Default to converting to tensor if no transform is provided

        # Create the superpixel map using SLIC
        superpixel_map, _ = create_superpixel_image(image, n_segments=self.n_segments)
