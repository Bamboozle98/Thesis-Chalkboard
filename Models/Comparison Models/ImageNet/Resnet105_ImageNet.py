...
def main():
    ...
    model = resnet101(weights="IMAGENET1K_V1")  # Updated to use 'weights' instead of 'pretrained'
    ...
    with torch.no_grad():
        val_loader_tqdm = tqdm(val_loader, desc="Validating Pretrained ResNet-101")
